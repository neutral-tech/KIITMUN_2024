                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                          ...
                          child: const Customcolortext(
                            customText: CustomText(
                              text:
                                  "The Ultimate Platform for Global Engagement, Diplomacy, and Empowering tomorrow's Leaders",
                              fontsize: 22,
                      ...
                      SizedBox(
                          ...
                          child: const CustomText(
                            text:
                                "Join us for the 12th Edition of KIIT International MUN!",
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                            ...
                            borderRadius:
                                BorderRadius.circular((12 / 390) * width),
                              ...
                              children: [
                                InkWell(
                                  ...
                                  child: const CustomBox(
                                    icon:
                                        "https://res.cloudinary.com/drpqitxvg/image/upload/v1743054862/comite_qgmss6.png",
                                    text: "Committees",
                                  ),
                                ),
                                SizedBox(
                                ...
                                InkWell(
                                  ...
                                  child: const CustomBox(
                                    icon:
                                        "https://res.cloudinary.com/drpqitxvg/image/upload/v1743054862/gallery_emxpf1.png",
                                    text: "Gallery",
                                  ),
                                ),
                              ],
                            ...
                            Row(
                              children: [
                                InkWell(
                                  ...
                                  child: const CustomBox(
                                    icon:
                                        "https://res.cloudinary.com/drpqitxvg/image/upload/v1743054862/aus_ncfjnr.png",
                                    text: "About Us",
                                  ),
                                ),
                                SizedBox(
                                ...
                                InkWell(
                                  ...
                                  child: const CustomBox(
                                    icon:
                                        "https://res.cloudinary.com/drpqitxvg/image/upload/v1743054862/dloads_fzui25.png",
                                    text: "Downloads",
                                  ),
                                ),
                              ],
                      ...
                      SizedBox(
                        ...
                        child: CachedNetworkImage(
                          imageUrl:
                              'https://res.cloudinary.com/drpqitxvg/image/upload/t_def/v1736746498/pic1_oedxib.png',
                          fit: BoxFit.fill,
                        ),
                      ...
                      Container(
                        decoration: BoxDecoration(
                          ...
                          borderRadius:
                              BorderRadius.circular((20 / 845) * height),
                        ),
                        width: (358 / 390) * width,
                        height: (375 / 390) * width,
                        child: CachedNetworkImage(
                          imageUrl:
                              'https://res.cloudinary.com/drpqitxvg/image/upload/v1736746489/anish_himdou.png',
                          fit: BoxFit.cover,
                        ),
                      ),
                      SizedBox(
                      ...
                      Container(
                          ...
                          decoration: BoxDecoration(
                              borderRadius:
                                  BorderRadius.circular((16 / 390) * width),
                              border: Border.all(
                                ...
                                child: Column(
                                  children: [
                                    Row(
                                      children: [
                                        SvgPicture.network(
                                            'https://res.cloudinary.com/drpqitxvg/image/upload/v1736750700/star_xohgo1.svg'),
                                        SizedBox(
                                          width: (5 / 390) * width,
                                        ),
                                        const Expanded(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              const Insigmia(
                                name: "Sarvagya Singh",
                                url:
                                    "https://res.cloudinary.com/drpqitxvg/image/upload/v1736746498/sarvagya_g06czf.png",
                                position: "DIRECTOR GENERAL",
                                text:
                                    "My journey with KIIT MUN over the past four years has been incredible. Starting as a participant, I advanced to delegate, organized multiple MUNs, and eventually led teams for major events. KIIT MUN has been the closest to my heart. KIIT MUN fosters critical thinking, diplomacy, and leadership, making it a platform that unites passionate individuals from diverse backgrounds. Growing within such a inspiring community has been an honor. As Director General of KIIT International MUN 2024, I'm excited about our goals for this year and look forward to growth, learning, and impactful discussions ahead.",
                              ),
                              SizedBox(
                                width: (30 / 845) * width,
                              ),
